        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-lg mx-auto mb-12">
            ...
            <p className="text-gray-600">
              ...
              mayonnaise, tailored to meet the diverse needs of food businesses
              worldwide. From flavorful classics to custom creations, our
              products are crafted with care and quality in every batch.
            </p>
          </div>
          <div className="text-center max-w-lg mx-auto mb-12">
            ...
            <p className="text-gray-600">
              ...
              industry by delivering high-quality sauces and condiments, backed
              by reliable service and innovative packaging solutions.
            </p>
          </div>
          <div className="text-center max-w-lg mx-auto mb-12">
            <h3 className="text-2xl font-semibold text-gray-800">
            ...
            <ul className="text-gray-600 list-disc list-inside">
              <li>
                Custom Solutions: We offer flexibility in flavors and packaging,
                providing both bulk solutions and ready-to-shelf bottled
                products.
              </li>
              <li>
              ...
              <li>
                ...
                manufacturing industry, we understand the unique demands of B2B
                clients and aim to exceed expectations with every order.
              </li>
            </ul>
          </div>
          <div className="text-center max-w-lg mx-auto mb-12">
          ...
          <div className="text-center max-w-lg mx-auto mb-12">
            ...
            <p className="text-gray-600">
              Partner with us to bring exceptional sauces and condiments to your
              business, and let us help you serve the best to your customers.
            </p>
          </div>
          <div className="text-center max-w-lg mx-auto mb-12">
            <h3 className="text-2xl font-semibold text-gray-800">
